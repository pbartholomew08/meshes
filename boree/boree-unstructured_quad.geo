...
// Inlet
Extrude {0, 0, -L_in} {
  Surface{16, 22, 14, 18, 20, 41, 43, 45, 39, 52, 68, 62, 64, 66};
  Layers{n_in};
  Recombine;
}
...
// Outlet
Extrude {0, 0, L_out} {
  Surface{14, 22, 20, 16, 18, 29, 39, 45, 43, 41, 52, 62, 64, 66, 68};
  Layers{n_out};
  Recombine;
}

// Volumes
Physical Volume(767) = {11, 9, 29, 6, 1, 2, 3, 5, 4, 8, 14, 7, 28, 22, 21, 12, 13, 15, 16, 17, 19, 18, 24, 26, 23, 27};

// Boundary conditions
Physical Surface(768) = {134, 90, 112, 178, 156}; // Nozzle inlet
Physical Surface(769) = {308, 222, 200, 266, 244, 330, 352, 396, 374}; // Coflow inlet
Physical Surface(772) = {766, 744, 678, 722, 700, 614, 636, 570, 592, 548, 484, 506, 462, 440, 418}; // Outlet
Physical Surface(771) = {695, 765, 329, 347, 713, 365, 387, 735, 147, 191, 169, 257, 221, 243, 29, 99, 77}; // Walls
